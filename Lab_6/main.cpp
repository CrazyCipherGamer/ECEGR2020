...
void ImportStudentData(void)
{
    ...
    {   
        ...
        studentFile >> ID;
        studentFile >> temp;
        firstName = (char*)malloc(strlen((temp.c_str())+1));
        strcpy(firstName, temp.c_str());
        studentFile >> temp;
        lastName = (char*)malloc(strlen((temp.c_str())+1));
        strcpy(lastName, temp.c_str());
        studentFile >> GPA;
...
void SaveStudentData()
{
    ...
    {
        myfile << currentStudent->getID() << endl;
        myfile.write(currentStudent->getFirstName(), strlen(currentStudent->getFirstName()));
        myfile << endl;
        myfile.write(currentStudent->getLastName(), strlen(currentStudent->getLastName()));
        myfile << endl;
        myfile << currentStudent->getGPA() << endl;
    }
...
void UpdateByID(int ID)
{
    ...
    while(nextStudent != nullptr)
    {
        ...
        if(currentStudent->getID() == ID)
        {
            ...
            cin >> temp;
            char *firstName = (char*)malloc(strlen((temp.c_str())+1));
            strcpy(firstName, temp.c_str());
            currentStudent->setFirstName(firstName);
            cout << "Enter new last name: ";
            cin >> temp;
            char *lastName = (char*)malloc(strlen((temp.c_str())+1));
            strcpy(lastName, temp.c_str());
